	...
	<div id="common-nav">
		...
		<div id="nav-content">
			...
			<ul class="grey">
				...
				<li><a href="/Login" id="login">请登录</a></li>
				<li><a href="javascript:void(0)" id="logout">退出</a></li>
				<li><a href="javascript:void(0)" id="order">我的订单</a></li>
				<li><a href="javascript:void(0)" id="cart">我的购物车</a></li>
				<li><a href="javascript:void(0)" id="message">我的消息</a></li>
				<li>|</li>
			</ul>
			<ul class="blue">
